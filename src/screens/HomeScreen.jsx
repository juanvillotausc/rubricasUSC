            ...
            <Section style={{ padding: 0 }}>
                <Box sx={{ margin: "auto", display: 'flex', flexDirection: 'row', maxWidth: "1220px", width: '75%', alignItems: 'center', justifyContent: 'center', height: "70vh" }}>
                    <div style={{ flex: 1, alignItems: 'left', justifyContent: "space-evenly", display: "flex", flexDirection: "column" }}>
                        ...
                        <Typography style={{ fontSize: "1em", textAlign: "left", width: "90%" }}>
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.
                        </Typography>
                        <div style={{ width: "100%" }}>
                            <ButtonStyled style={{ marginTop: 15, marginRight: 15, textTransform: "none", backgroundColor: "" }} onClick={handleCreateRubric}>Diseñar</ButtonStyled>
                            <Link style={{ textDecoration: "none" }} to="/rubric/generate">
                                <ButtonStyled style={{ marginTop: 15, textTransform: "none", backgroundColor: "" }}>
                                    Generar
                                </ButtonStyled>
                            </Link>
                        </div>
                    </div>
                    <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: "center", padding: 15 }}>
